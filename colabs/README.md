...
本文件夹包含 Neural Networks: Zero to Hero 课程对应的 Google Colab 笔记本链接，方便直接在浏览器中运行代码。

所有链接均根据 YouTube 视频下方的描述信息整理。

| Lecture | 主题 | YouTube | Colab 链接 |
|---------|------|---------|------------|
| 1 | 反向传播 (micrograd) | [🎬](https://www.youtube.com/watch?v=VMj-3S1tku0) | [Colab](https://colab.research.google.com/github/karpathy/nn-zero-to-hero/blob/master/lectures/micrograd/micrograd_lecture_first_half_roughly.ipynb) |
| 2 | 语言建模入门 (makemore) | [🎬](https://www.youtube.com/watch?v=PaCmpygFfXo) | [Colab](https://colab.research.google.com/github/karpathy/nn-zero-to-hero/blob/master/lectures/makemore/makemore_part1_bigrams.ipynb) |
| 3 | 多层感知机 (MLP) | [🎬](https://www.youtube.com/watch?v=TCH_1BHY58I) | [Colab](https://colab.research.google.com/github/karpathy/nn-zero-to-hero/blob/master/lectures/makemore/makemore_part2_mlp.ipynb) |
